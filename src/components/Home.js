      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            <LineCharts
              title={`Issues Created for ${repository.value} in 24 months`}
              give = 'Issues'
              data={githubRepoData?.created}
            />
            ...
            <BarCharts
              title={`Stars`}
              give = 'Stars'
              data={githubRepoData?.st}
            />
            <BarCharts
              title={`Forks`}
              give = 'Forks'
              data={githubRepoData?.fk}
            />
            <BarCharts
              title={`Weekly Closed Issues for ${repository.value}.`}
              give = 'Issues'
              data={githubRepoData?.weekClosed}
            />
            <div>
              <img
                src={githubRepoData?.closedAtImageUrls?.stackBarImageURL}
                loading={"lazy"}
              />
            </div>
            <div>
              <img
                src={githubRepoData?.closedAtImageUrls?.weekCreatedImageURL}
                loading={"lazy"}
              />
            </div>
            <div>
              <img
                src={githubRepoData?.closedAtImageUrls?.weekClosedImageURL}
                loading={"lazy"}
              />
            </div>
            <div>
              <img
                src={githubRepoData?.closedAtImageUrls?.monthClosedImageURL}
                loading={"lazy"}
              />
            </div>
